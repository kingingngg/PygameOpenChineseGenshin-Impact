...
Use Pygame to open the Chinese version of Genshin Impact, but this is not a game.You can think of this as a meaningless program (perhaps)!  
使用Pygame打开一个假原神，他不是真正的游戏，你可以理解成这是一个毫无意义的程序（或许）！
